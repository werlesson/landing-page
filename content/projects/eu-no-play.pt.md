...
results: 'Em produção em 3 arenas parceiras (5 quadras), com 987 usuários cadastrados e mais de 50 vídeos gerados por dia — cerca de 1.700 clipes já salvos pelos jogadores em suas contas. 17 marcas anunciam dentro dos vídeos, transformando cada replay em superfície de patrocínio. Da jogada ao replay pronto para baixar em menos de 1 minuto, sem operador de câmera dedicado.'
gallery:
