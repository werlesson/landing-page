<template>
  ...
  >
    ...
    <div class="pointer-events-none absolute inset-0 overflow-hidden" aria-hidden="true">
      <div
        class="absolute -right-40 -top-40 h-80 w-80 rounded-full bg-accent/5 blur-3xl"
      />
      <div
    ...
    <div class="relative z-10 mx-auto max-w-4xl">
      ...
      >
        <div class="mb-6 flex items-center gap-3">
          <div
            class="h-px w-12 bg-gradient-to-r from-accent to-transparent"
            aria-hidden="true"
          />
          <span
            class="text-sm font-medium uppercase tracking-widest text-accent"
          >
            {{ $t('about.badge') }}
          </span>
        </div>
        ...
        <h2
          class="font-display text-4xl font-bold text-foreground md:text-5xl lg:text-6xl"
        >
          ...
          <span class="relative inline-block">
            ...
            <span
              class="absolute -inset-1 -z-0 block rounded bg-accent/10"
              aria-hidden="true"
            />
          </span>
        </h2>
